...
<x-formulario :cTitulo="$caTitulo" :cNombreRuta="$caNombreRuta" :cRegistro="$caRegistro">
    ...
    <x-slot name="sInputs">
        {{ $slot ?? null }}
        <label for="">Cargo:<br>
            <input type="text" name="cargo" placeholder="Ingrese cargo" class="inputs w-1/4">
        </label><br>
        <label for="">Descripción:<br>
            <textarea name="descripcion" placeholder="Ingrese descripción" class="inputs w-1/2 h-40"></textarea>
        </label><br>
        <div>
